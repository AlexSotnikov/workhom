...
describe 'Work4' do
  it 'Test class Line draw' do
    Line.new(50, 160, 50, 220).draw.should eq('<line x1="50" x2="50" y1="160" y2="220" stroke-width="1" stroke="black" />')
  end
  it 'Test cass Rect draw' do
    Rect.new(42, 120, 16, 40).draw.should eq('<rect x="42" y="120" width="16" height="40" />')
  end
  it 'Test Circle draw' do
    Circle.new(50, 180, 3, 'black').draw.should eq('<circle cx="50" cy="180" r="3" fill="black" stroke="black" />')
    Circle.new(70, 235, 25).draw.should eq('<circle cx="70" cy="235" r="25" fill="none" stroke="black" />')
    end
end
